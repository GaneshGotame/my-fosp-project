...
<body>
	...
	<h2>Delete Habits</h2>
	<p style="font-size: 20px;">Click on Delete to remove your detail<br>
		This is habit detail of
				...
				$id=$row['habit_id'];
					?>
   						...
   						<tr>
   		 				...
   		 				<td>
   		 					<a href="dbms_deletehabit.php?id=<?php echo $id?>" style="text-decoration: none; color: red;">DELETE   </a>
